    ...
    class cf7costcaloc_cf7_panel {
                ...
                <table class="paypal_main">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="regular-text" name="paypal_bus_email" value="<?php echo get_post_meta( $formid, CF7COSTCALOCPREFIX.'paypal_bus_email', true );?>">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                            ...
                            <td>
                                ...
                                <input type="number" class="regular-text" name="amount" value="<?php echo get_post_meta( $formid, CF7COSTCALOCPREFIX.'amount', true );?>" style="display: none;">

                                <input type="text" class="regular-text" name="fieldamount" value="<?php echo get_post_meta( $formid, CF7COSTCALOCPREFIX.'fieldamount', true );?>" style="display: none;">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                            ...
                            <td>
                                ...
                                <input type="number" class="regular-text" name="quantity" value="<?php echo get_post_meta( $formid, CF7COSTCALOCPREFIX.'quantity', true );?>" style="display: none;" min="1">

                                <input type="text" class="regular-text" name="fieldquantity" value="<?php echo get_post_meta( $formid, CF7COSTCALOCPREFIX.'fieldquantity', true );?>" style="display: none;">
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="regular-text" name="suc_url" value="<?php echo get_post_meta( $formid, CF7COSTCALOCPREFIX.'suc_url', true );?>">
                            </td>
                        </tr> 
                        <tr>
                            <th scope="row">
                            ...
                            <td>
                                <input type="text" class="regular-text" name="can_url" value="<?php echo get_post_meta( $formid, CF7COSTCALOCPREFIX.'can_url', true );?>">
                            </td>
                        </tr> 
                    </tbody>
                </table>
        ...
        function cf7costcaloc_paypal_callback() {
            ...
            if (!is_wp_error($response) && $response['response']['code'] >= 200 && $response['response']['code'] < 300 && strstr($response['body'], 'VERIFIED')) {
                ...
                $item_name        = $ipn_response['item_name'];
                $item_number      = $ipn_response['item_number'];
                $payment_status   = $ipn_response['payment_status'];
                $payment_amount   = $ipn_response['mc_gross'];
                $payment_currency = $ipn_response['mc_currency'];
                $txn_id           = $ipn_response['txn_id'];
                $receiver_email   = $ipn_response['receiver_email'];
                $payer_email      = $ipn_response['payer_email'];
                $form_id          = $ipn_response['custom'];
