...
class Data_List_Table extends WP_List_Table{
    ...
    public function process_bulk_action(){
        ...
        if( 'delete' === $action ) {
            ...
            endforeach;
            wp_redirect(admin_url( 'admin.php?page=cf7costcaloc_paypal_entries&cf7costcaloc_formid='.$_GET['cf7costcaloc_formid'] ));
            exit;
            ...
            <div id="welcome-panel" class="welcome-panel">
                <div class="welcome-panel-content">
                    <div class="welcome-panel-column-container">
                        ...
                        <h2 style="color: #000;"><?php echo get_the_title( $this->form_post_id ); ?></h2>
